...
MADRS_INTRO = {
    ...
    'it': 'Per favore, nota che: Questo test è in genere somministrato da un clinico di terze parti, ma viene fornito qui per '
          'scopi informativi. Questo test potrebbe non essere accurato quando viene auto-somministrato, dato che si basa su una valutazione alquanto soggettiva.\n'
